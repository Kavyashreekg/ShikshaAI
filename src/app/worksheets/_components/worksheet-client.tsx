...
const translations = {
  ...
  Odia: {
    ...
    noWorksheetsDescription: 'AI ପ୍ରଦାନ କରାଯାଇଥିବା ପ୍ରତିଛବିରୁ କାର୍ଯ୍ୟପତ୍ର ସୃଷ୍ଟି କରିପାରିଲା ନାହିଁ। ଦୟାକରି ଏକ ସ୍ପଷ୍ଟ ପ୍ରତିଛବି କିମ୍ବା ଭିନ୍ନ ପୃଷ୍ଠା ଚେଷ୍ଟా କରନ୍ତୁ।',
  ...
  Assamese: {
    ...
    historyDialogTitle: 'সংৰক্ষিত কাৰ্যপত্ৰ',
    historyDialogDescription: 'ইয়াত সেইবোৰ কাৰ্যপত্ৰ আছে যিবোৰ আপুনি অতীতত সৃষ্টি কৰিছে। আপুনি সেইবোৰ চাব, লোড কৰিব বা মচি পেলাব পাৰে।',
    noHistory: 'আপুনি এতিয়ালৈকে কোনো কাৰ্যপত্ৰ সৃষ্টি কৰা নাই।',
    loadWorksheetButton: 'কাৰ্যপত্ৰ লোড কৰক',
    deleteWorksheetButton: 'মচি পেলাওক',
    formErrors: {
