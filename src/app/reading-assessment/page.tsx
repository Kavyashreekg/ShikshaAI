...
const pageTranslations = {
  ...
  Odia: {
    ...
    description: 'ଶବ୍ଦକୋଷରେ ଉନ୍ନତି ଆଣିବା ପାଇଁ ଛାତ୍ର-ଅନୁକୂଳ ପଠନ ଅନୁଚ୍ଛେଦ ସୃଷ୍ଟି କରନ୍ତୁ।',
  },
  Assamese: {
    title: 'পঠন মূল্যায়ন',
    description: 'শব্দভাণ্ডাৰ উন্নত কৰিবলৈ শিক্ষাৰ্থী-अनুকূল পঠন অনুচ্ছেদ সৃষ্টি কৰক।',
  },
  Kannada: {
